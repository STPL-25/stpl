...
// function ApprovalScreenLayout({approvalName,prList,selectedPR,handlePRSelect,handleAction,showApprovalDialog,setShowApprovalDialog,action,comments,setComments,handleSubmit,loading,actionType}  :any) {
...
//             <p className="text-sm text-slate-600 dark:text-slate-400">{prList.length} total Lists</p>
//           </div>
